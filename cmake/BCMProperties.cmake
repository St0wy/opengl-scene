...
# On MSVC very annoyingly cmake puts /EHsc and /MD(d) into the global flags which means you get a warning when you try
# to disable exceptions or use the static CRT. I hate to use this globally imposed solution, but we are going to hack
# the global flags to use properties to determine whether they are on or off
#
# Create custom properties called CXX_EXCEPTIONS, CXX_RTTI and CXX_STATIC_RUNTIME These get placed at global, directory
# and target scopes
foreach(scope GLOBAL DIRECTORY TARGET)
	define_property(
		${scope}
		PROPERTY "CXX_EXCEPTIONS"
		INHERITED
	...
	define_property(
		${scope}
		PROPERTY "CXX_WARNINGS_AS_ERRORS"
		INHERITED
...
endforeach()
# Set the default for these properties at global scope. If they are not set per target or whatever, the next highest
# scope will be looked up
...
option(CMAKE_CXX_WARNINGS_AS_ERRORS
	   "Treat warnings as errors and abort compilation on a warning, defaults to OFF at global scope" OFF
)
