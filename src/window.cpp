...
stw::Window::Window(std::unique_ptr<Scene> scene, const char *windowName, const std::int32_t windowWidth,
    ...
    : m_Scene(std::move(scene))
{
    ...
    m_Window = SDL_CreateWindow(windowName, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, windowWidth, windowHeight,
