...
export
{
	...
	void stw::Framebuffer::BindRead() const { glBindFramebuffer(GL_READ_FRAMEBUFFER, m_Fbo); }

	void stw::Framebuffer::BindWrite() const { glBindFramebuffer(GL_DRAW_FRAMEBUFFER, m_Fbo); }
